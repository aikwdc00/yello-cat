...
window.addEventListener('mousemove', (e) => {
    ...
    tri[0].style.transform = `translateX(${about_x / -25}px)`
    tri[1].style.transform = `translateX(${about_x / -15}px)`
    tri[2].style.transform = `translateX(${about_x / -10}px)`
    tri[3].style.transform = `translateX(${about_x / -15}px)`
    tri[4].style.transform = `translateX(${about_x / -20}px)`
